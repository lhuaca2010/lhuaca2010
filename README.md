...
## Perfil 🖋️
Como profesional en formación de Ingeniería de sistemas, mis capacidades incluyen :
...
He trabajado con plataformas SAP BW/Hana desarrollando flujos ETL para migración e integración de datos. Manejo bases de datos como Oracle, SQL Server, MySQL y Snowflake. Además, he utilizado lenguajes como Java y Python para desarrollo y automatizaciones, y herramientas como Power BI, Excel, Git y Azure DevOps para creacion de reportes/dashboards y gestión técnica.
